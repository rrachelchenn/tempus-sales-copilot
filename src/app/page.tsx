    ...
    <div className="mx-auto flex min-h-screen max-w-6xl flex-col gap-6 px-4 py-8 md:flex-row">
      <aside className="w-full rounded-xl border border-slate-800 bg-slate-900/60 p-4 md:w-80">
        ...
        <p className="mt-1 text-sm text-slate-300">
          Upload your local data sources and let the copilot prioritize leads,
          handle objections, and draft a 30s pitch.
        </p>
        ...
        <div className="mt-6">
          ...
          <div className="mt-2 max-h-[420px] space-y-1 overflow-auto pr-1 text-sm">
